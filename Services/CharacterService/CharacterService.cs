...
namespace dotnet_rpg.Services.CharacterService
{
    public class CharacterService : ICharacterService
    {
        ...
        public async Task<ServiceResponse<List<GetCharacterDto>>> AddCharacter (AddCharacterDto newCharacter)
        {
            ...
            serviceResponse.Data = (_context.Characters.Where (f => f.User.Id == GetUserId ()).Select (c => _mapper.Map<GetCharacterDto> (c))).ToList ();
        ...
        public async Task<ServiceResponse<GetCharacterDto>> GetCharacterById (int id)
        {
            ...
            Character dbCharacter = await _context.Characters
                .Include (c => c.Weapon)
                .Include (c => c.CharacterSkills).ThenInclude (s => s.Skill)
        ...
        public async Task<ServiceResponse<GetCharacterDto>> UpdateCharacter (UpdateCharacterDto updateCharacter)
        {
            ...
            try
            {
                ...
                if (character.User.Id == GetUserId ())
                {
                    ...
                    character.Defence = updateCharacter.Defense;
